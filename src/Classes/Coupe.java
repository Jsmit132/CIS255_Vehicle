...
public abstract class Coupe implements IVehicle {
    ...
    // Constructor to initialize the Coupe object with the given details
    ...
    // Method to display the details of the Coupe with a header
    @Override
    ...
    // Method to display the details of the Coupe without a header
    @Override
